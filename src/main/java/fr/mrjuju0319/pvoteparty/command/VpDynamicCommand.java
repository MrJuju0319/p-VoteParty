...
public final class VpDynamicCommand extends Command {
    ...
    public VpDynamicCommand(PVotePartyPlugin plugin, VoteService voteService) {
        super("vp", "Gestion des votes et de la vote-party", "/vp [reload|add vote <nombre> <joueur>|setpallier <joueur> <pallier> <true/false>|reset pallier <joueur|all> <pallier|all>|party]", Collections.singletonList("voteparty"));
