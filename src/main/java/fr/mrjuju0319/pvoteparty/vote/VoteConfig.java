...
public record VoteConfig(
    ...
    public static VoteConfig fromConfig(FileConfiguration config) {
        ...
        return new VoteConfig(
                ...
                Collections.unmodifiableList(config.getStringList("vote.party-global-rewards")),
                Collections.unmodifiableList(config.getStringList("vote.party-player-rewards")),
